...
import arrivalInfoData from './data/arrival-info.json';
import services from './data/services.json';
import accessibilities from './data/accessibility.json'
        ...
        <div className="scene" id="hotelinfo">
            ...
            <article id="usefulinfo">
                ...
                <ul>
                  {
                    arrivalInfoData.map((info) => 
                      <li><strong>{info.text1}:</strong> {info.text2}</li>
                    )
                  }
                </ul>
              </section>
              ...
              <section className="checklist" id="accessibility">
                ...
                <ul>
                  {
                    accessibilities.map(item => <li>{item.text}</li>)
                  }
                </ul>
              </section>
            </article>
